...
## ローカルでいろいろ弄ったけど、元の状態に戻したい[2023-04-19]

あれこれ作業をしていたけれど、「これまでやった作業を元に戻したい・・・」と悲観したときの戻し方です。  

### やり方

`git checkout .` で元通り！  
特定のファイルだけ戻すなら`git checkout <filename>`です。  
